...
export const frInstrumentTranslations = {
    ...
    preamble: [
        ...
        "### 4. Soutien à la sociabilité\nLe soutien à la sociabilité évalue si plus d’un enfant ou d’une personne peut utiliser cette caractéristique de l’équipement ou de l’environnement ensemble. Il prend en compte la possibilité d’utiliser l’élément par plusieurs personnes à la fois, individuellement, en petits groupes ou en groupes plus importants.\n\n**Question guide :** Plus d’un enfant (ou d’une personne) peut-il utiliser cette caractéristique ensemble ?\n\nExemple : Certaines balançoires peuvent-elles être utilisées seules ? Certaines peuvent-elles être utilisées à deux ? Certaines peuvent-elles être utilisées en groupes d’enfants ?\n\n**C’est à vous d’indiquer s’ils peuvent être utilisés seuls, à deux ou en groupe.**",
        "## Réflexion libre\nLa question ouverte vous donne la possibilité de noter certaines réflexions. Une question guide vous demandera de décrire un ou deux aspects que vous recommandez de modifier dans l’aire de jeu afin d’augmenter sa valeur ludique et son utilisabilité.",
        "## Deux parties de l’audit\nL’outil d’audit de la valeur ludique et de l’utilisabilité des aires de jeu utilise deux méthodes pour évaluer une aire de jeu :\n\n- **(A) Audit sur site de l’environnement physique**\nCette partie de l’audit évalue les aspects de l’aire de jeu qui ne peuvent être examinés que sur site, dans l’environnement physique.\nElle nécessite une présence physique sur l’aire de jeu.\n\n- **(B) Enquête sur les aspects écologiques de l’aire de jeu**\nCette partie de l’audit évalue les informations liées à l’historique, aux pratiques de gestion et à la manière dont la météo et les saisons influencent l’utilisation de l’aire de jeu.\nElle ne nécessite pas d’être sur site.\nElle doit être renseignée par une personne connaissant l’historique et le contexte de l’aire de jeu.",
        "## Avant de continuer\nAvant de passer à la section suivante, vous devez décider quelle(s) partie(s) de l’audit vous allez compléter : A, B, ou A & B.\n\nVotre choix dépend du degré de familiarité que vous avez avec l’aire de jeu et du rôle que vous occupez.",
    ],
    executionModes: {
        both: {
