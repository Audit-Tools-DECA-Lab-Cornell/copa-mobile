...
export const deInstrumentTranslations = {
    ...
    preamble: [
        "## Wie das Tool aufgebaut ist\nDas Comprehensive Outdoor Playspace Audit (COPA) Tool ist in 22 Bereiche gegliedert. Jeder Bereich umfasst zwischen 2 und 12 Items. Alle Items stehen für bestimmte Merkmale oder Eigenschaften der Umgebung.",
