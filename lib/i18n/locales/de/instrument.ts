...
export const deInstrumentTranslations = {
    ...
    preamble: [
        ...
        "### 4. Unterstützung sozialer Interaktion\nDie Unterstützung sozialer Interaktion bewertet, ob mehr als ein Kind/eine Person dieses Merkmal/diese Umgebungsqualität gemeinsam nutzen kann. Dabei wird berücksichtigt, ob das Merkmal von mehr als einer Person gleichzeitig, einzeln, in kleinen Gruppen oder in größeren Gruppen genutzt werden kann.\n\n**Leitfrage:** Können mehr als ein Kind (oder eine Person) dieses Merkmal gemeinsam nutzen?\n\nBeispiel: Können einige der Schaukeln allein genutzt werden? Können einige zu zweit genutzt werden? Können einige von Kindergruppen genutzt werden?\n\n**Es liegt in Ihrem Ermessen anzugeben, ob sie allein, zu zweit oder in Gruppen genutzt werden können.**",
        "## Offene Reflexion\nDie offene Frage gibt Ihnen die Möglichkeit, einige Überlegungen festzuhalten. Eine Leitfrage bittet Sie, ein oder zwei Aspekte zu beschreiben, die Sie zur Verbesserung des Spielwerts und der Nutzbarkeit des Playspace ändern würden.",
        "## Zwei Teile der Begehung\nDas Audit-Tool Playspace Play Value and Usability Audit verwendet zwei Methoden zur Bewertung eines Playspace:\n\n- **(A) Vor-Ort-Audit der physischen Umgebung**\nDieser Teil des Audits bewertet Aspekte des Playspace, die nur vor Ort in der physischen Umgebung untersucht werden können.\nEr erfordert Ihre physische Anwesenheit im Playspace.\n\n- **(B) Befragung zu ökologischen Aspekten des Playspace**\nDieser Teil des Audits bewertet Informationen zur Geschichte, zu Managementpraktiken und dazu, wie Wetter und Jahreszeiten die Nutzung des Playspace beeinflussen.\nEr erfordert keine Vor-Ort-Anwesenheit.\nEr muss von einer Person beantwortet werden, die mit dem Hintergrund und dem Kontext des Playspace vertraut ist.",
        "## Bevor Sie fortfahren\nBevor Sie zum nächsten Abschnitt wechseln, müssen Sie entscheiden, welchen Teil bzw. welche Teile des Audits Sie durchführen werden: A, B oder A & B.\n\nIhre Wahl hängt davon ab, wie gut Sie mit dem Playspace vertraut sind und welche Rolle Sie haben.",
    ],
    executionModes: {
        both: {
